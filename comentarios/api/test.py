...
class ComentariosAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        comentario = Comentario.objects.create(mensaje="Mensaje Test",
                                               usuario=usuario,
                                               fecha="1996-08-15",
                                               hora="12:00:00",
                                               calificacion=1)
    ...
    def test_single_comentario(self):
        comentarios_count = Comentario.objects.count()
        self.assertEqual(comentarios_count, 1)

    #########################################################################
    def test_get_comentarios_list_forbidden(self):
        data = {}
        url = api_reverse("api-comments:comments-create")
        response = self.client.get(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)

    #########################################################################
    def test_get_comentarios_list_with_user_ok(self):
    ...
    #########################################################################
    def test_post_comentarios_with_user_admin(self):
        self.client.credentials(
            HTTP_AUTHORIZATION="eyJhbGciOiJSUzI1NiIsImtpZCI6Ijg1OWE2NDFhMWI4MmNjM2I1MGE4MDFiZjUwNjQwZjM4MjU3ZDEyOTkiLCJ0eXAiOiJKV1QifQ..v75f3olYx5wtqCCbJjO7rrpAhyrSwxIQUQShc7YYYJjPYkxpScM8Wo9KwJRmhsjhe8I9Y5xe1fKVroJGfo-TbfW4TQ8nXWo9uWLix7D9j6oj32tkz_kwc396kJXifQphRqtK4_8mjbFMP9cNt2pBn81YORY19o8G6rKaC8pOPAwJrsVk2--OcBOCYpQu_OfuCEUippRiGh2piPIkN6kQjeB675UD8xTfjblqKGFwt4vi2MNRurKsnmRdg3hZmvMpRO7q1dk3R2y4NYUoCw37alypnIZnh_LabVjDb6-7iW3g_VqPLUayp8JDHfAzsN6Q7kxzjTLkMSfMNutP1ca07w")

        data = {"mensaje": "Mensaje Test",
                "usuario":1,
                "fecha":"1996-08-15",
                "hora":"15:00:00",
                "calificacion":5}
    ...
    #########################################################################
    def test_put_comentarios_with_user_admin(self):
        self.client.credentials(
            HTTP_AUTHORIZATION="eyJhbGciOiJSUzI1NiIsImtpZCI6Ijg1OWE2NDFhMWI4MmNjM2I1MGE4MDFiZjUwNjQwZjM4MjU3ZDEyOTkiLCJ0eXAiOiJKV1QifQ..v75f3olYx5wtqCCbJjO7rrpAhyrSwxIQUQShc7YYYJjPYkxpScM8Wo9KwJRmhsjhe8I9Y5xe1fKVroJGfo-TbfW4TQ8nXWo9uWLix7D9j6oj32tkz_kwc396kJXifQphRqtK4_8mjbFMP9cNt2pBn81YORY19o8G6rKaC8pOPAwJrsVk2--OcBOCYpQu_OfuCEUippRiGh2piPIkN6kQjeB675UD8xTfjblqKGFwt4vi2MNRurKsnmRdg3hZmvMpRO7q1dk3R2y4NYUoCw37alypnIZnh_LabVjDb6-7iW3g_VqPLUayp8JDHfAzsN6Q7kxzjTLkMSfMNutP1ca07w")

        comentarios = Comentario.objects.first()
        url = comentarios.get_api_url()

        data = {"mensaje": "Mensaje Test x2",
                "usuario": 1,
                "fecha": "2019-01-25",
                "hora": "21:07:00",
                "calificacion": 3}
