"""
Django settings for BackendTG project.
...
SECRET_KEY = '*-alkf#1!ph-sggks8c$b#gz)uexf5outt=-y_)z526$m(8t_d'
...
WSGI_APPLICATION = 'BackendTG.wsgi.application'
