...
class CategoriasAPITestCase(APITestCase):
    ...
    def setUp(self):
        categoria = Categoria.objects.create(nombre="Test Categoria", foto="Test Foto Categoria")
    ...
    def test_post_categorias_with_user_admin(self):
        ...
        data = {"nombre": "Some random title", "descripcion":"Some random description"}
    ...
    def test_put_categorias_with_user_admin(self):
        ...
        comentarios = Categoria.objects.first()
